...
//$stmt = $conn->prepare("SELECT index_tg FROM tgtrialtrustee WHERE worker_ID='$mturkworkerID'");
$stmt = $conn->prepare("SELECT index_cpd FROM mover2 WHERE worker_ID='$mturkworkerID' ORDER BY index_cpd DESC LIMIT 1");
$stmt->execute();
